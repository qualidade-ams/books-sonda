-- ============================================================================
-- Migration: Fix RLS policies duplicates for banco_horas_calculos_segmentados
-- Criado: 2026-02-18
...
DO $$
BEGIN
  RAISE NOTICE '📊 Relatório de Políticas RLS - banco_horas_calculos_segmentados';
  RAISE NOTICE '==================================================';
END $$;
...
COMMENT ON TABLE banco_horas_calculos_segmentados IS 'Tabela de cálculos segmentados de banco de horas - RLS corrigido em 2026-02-18';
