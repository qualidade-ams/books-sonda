        ...
        try {
          ...
          try {
            const excelFile = await gerarExcelDetalhadoBook({
              ...
              mes: mesReferencia,
              ano: anoReferencia,
              diaInicioApuracao: bookInfo?.dia_inicio_apuracao ?? 1,
            });
            ...
            if (excelFile) {
              ...
              if (!excelUploadError) {
                ...
                console.warn('⚠️ Erro upload Excel:', excelUploadError);
              }
            }
          } catch (excelError) {
          ...
          // 7. Enviar email com retry para rate limiting
