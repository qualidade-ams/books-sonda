-- Migration: Correção DEFINITIVA de RLS para banco_horas_calculos
-- Data: 2026-02-05
-- Descrição: Usa user_group_assignments para relacionar usuários com grupos
-- Resolve: Erro 404 (relation "user_group_members" does not exist)
...
-- ============================================================================
-- PASSO 3: CRIAR FUNÇÃO DE VERIFICAÇÃO (usando user_group_assignments)
-- ============================================================================
...
BEGIN
  ...
  -- Verificar se o usuário tem permissão para banco de horas
  -- Usa user_group_assignments para relacionar usuário com grupo
  SELECT EXISTS (
    SELECT 1
...
BEGIN
  RAISE NOTICE '
╔════════════════════════════════════════════════════════════════╗
║  ✅ Migration DEFINITIVA aplicada com sucesso!                 ║
╠════════════════════════════════════════════════════════════════╣
║  ✅ Políticas antigas removidas (incluindo temporárias)        ║
║  ✅ RLS habilitado                                             ║
║  ✅ Função corrigida (usa user_group_assignments)              ║
