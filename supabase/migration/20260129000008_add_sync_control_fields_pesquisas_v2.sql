...
-- Data: 2026-01-29
-- Versão: 2.0 (com limpeza de duplicatas integrada)
-- =====================================================
...
-- Passo 4: Criar função para gerar hash de registro
...
-- Passo 5: Criar função para gerar chave única
...
-- Passo 6: Atualizar registros existentes com chave_unica e hash
...
-- Passo 7: Remover duplicatas antes de criar índice único
-- Manter apenas o registro mais recente de cada chave_unica
DO $$
DECLARE
  v_duplicatas_removidas INTEGER := 0;
  v_total_antes INTEGER := 0;
  v_total_depois INTEGER := 0;
BEGIN
  RAISE NOTICE '========================================';
  RAISE NOTICE '🧹 LIMPEZA DE DUPLICATAS';
  RAISE NOTICE '========================================';
  ...
  RAISE NOTICE '📊 Total de registros antes: %', v_total_antes;
  ...
  RAISE NOTICE '🗑️  Duplicatas removidas: %', v_duplicatas_removidas;
  RAISE NOTICE '📊 Total de registros depois: %', v_total_depois;
  RAISE NOTICE '========================================';
END $$;

-- Passo 8: Adicionar constraint de unicidade para chave_unica
...
BEGIN
  ...
  RAISE NOTICE '📊 Duplicatas restantes: %', v_duplicatas_restantes;
  RAISE NOTICE '========================================';
  ...
  IF v_duplicatas_restantes > 0 THEN
    RAISE WARNING '⚠️ ATENÇÃO: Ainda existem % duplicatas!', v_duplicatas_restantes;
    RAISE WARNING '⚠️ Execute o script de limpeza adicional se necessário';
  ELSE
    RAISE NOTICE '✅ Nenhuma duplicata - banco limpo e pronto!';
  END IF;
END $$;
