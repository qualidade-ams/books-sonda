...
│   │   │   │   ├── LoadingStates.tsx				   # Componentes de skeleton loading para sistema de requerimentos (LoadingSpinner para indicadores de carregamento, StatsCardSkeleton para cards de estatísticas, RequerimentoCardSkeleton para cards de requerimentos com layout horizontal alinhado incluindo checkbox de seleção 4%, PageLoadingSkeleton para página completa, FiltersSkeleton para seção de filtros, otimizados para layout flexbox com larguras ajustadas 4%/11%/14%/6%/6%/5%/5%/5%/7%/7%/8%/7%/7%/8% incluindo novas colunas Valor Total e Autor, responsividade completa e alinhamento perfeito com cabeçalho da lista)
